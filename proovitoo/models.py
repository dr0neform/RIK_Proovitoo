...
class Detail(models.Model):
    ...
    shareholder_company_name = models.CharField(max_length=10, null=True, blank=True)
    ...
    id_code = models.CharField(max_length=12, validators=[MinLengthValidator(12)], null=True, blank=True)
